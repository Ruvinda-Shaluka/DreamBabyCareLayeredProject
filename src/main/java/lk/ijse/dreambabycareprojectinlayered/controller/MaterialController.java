...
import lk.ijse.dreambabycareprojectinlayered.view.tdm.MaterialTM;
...
public class MaterialController implements Initializable {
    ...
    public void saveBtnOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isSaved = materialBO.save(new MaterialDto(
                    materialId,
                    name,
                    colorType,
    ...
    public void updateBtnOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isUpdated = materialBO.update(new MaterialDto(
                    materialId,
                    name,
                    colorType,
                    Integer.parseInt(quantity)
    ...
    public void deleteBtnOnAction(ActionEvent actionEvent) {
        ...
        if (result.isPresent() && result.get() == ButtonType.YES) {
            ...
            if (materialId != null) {
                try {
                    boolean isDeleted = materialBO.delete(materialId);
                    if (isDeleted) {
    ...
    private void loadNextId() {
        try {
            String nextId = materialBO.generateNewId();
    ...
    private void loadMaterialsTableData() throws Exception {
        tblMaterial.setItems(FXCollections.observableArrayList(
                materialBO.loadAll()
                        .stream()
                        .map(
